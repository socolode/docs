...
Combined with `calculate_stats()`, you can easily implement volume detection or sound energy analysis.
...
- Calling other methods before initialization will raise an exception.
:::