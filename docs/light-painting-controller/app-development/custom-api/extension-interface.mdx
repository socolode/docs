...
- When powered by battery, you must actively turn on "VCC output" through [power management (pm)](./power-management.mdx) to get 5V output.
...
Combined with the neopixel library, connect WS2812-type color LEDs through the top 5-PIN interface to easily implement light control. See [Neopixel (WS2812) Control](./ws2812-neopixel-control.mdx) for detailed usage.